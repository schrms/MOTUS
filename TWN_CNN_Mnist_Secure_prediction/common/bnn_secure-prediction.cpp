...
uint32_t* BNN_Mnist_Secure_prediction(e_role role, char* address, uint16_t port, seclvl seclvl,
		...
		uint32_t *W3, uint32_t W3nvals, uint32_t *u3, uint32_t u3nvals, 

		uint32_t *W4, uint32_t W4nvals, uint32_t *s4, uint32_t s4nvals, uint32_t *t4, uint32_t t4nvals, 

		uint32_t *posids_W1, uint32_t *posids_W2, uint32_t *posids_W3, uint32_t *posids_W4,  
		uint32_t *W1posids_index, uint32_t *W2posids_index, uint32_t *W3posids_index, uint32_t *W4posids_index) {
	...
	*/
	...
	share *s_W1, *s_input, *s_hidden1_1, *s_u1, *s_hidden1_2, *s_hidden1_3, *s_hidden1_4,
	 *s_W2, *s_hidden2_1, *s_u2, *s_hidden2_2, *s_hidden2_3, *s_hidden2_4,
	 *s_W3, *s_hidden3_1, *s_u3, *s_hidden3_2, *s_hidden3_3,
	 *s_W4, *s_hidden4_1, *s_s4, *s_t4, *s_hidden4_2, *s_out;
	...
	s_u3 = circ->PutSharedSIMDINGate(u3nvals, u3, bitlen);

	s_W4 = circ->PutSharedSIMDINGate(W4nvals, W4, bitlen);
	s_s4 = circ->PutSharedSIMDINGate(s4nvals, s4, bitlen);
	s_t4 = circ->PutSharedSIMDINGate(t4nvals, t4, bitlen);

	/* The first layer */

	s_hidden1_1 = Convolution(s_W1, s_input, 28, 28, 1, 5, 5, 1, 16, bitlen, (ArithmeticCircuit*) circ, posids_W1, W1posids_index);
	s_hidden1_2 = BatchnormAct(s_hidden1_1, s_u1, (ArithmeticCircuit*) circ);
	s_hidden1_3 = ActivationMax(s_hidden1_2, 24, 24, 16, bitlen, (ArithmeticCircuit*) circ, (BooleanCircuit*) booleancirc, (BooleanCircuit*) yaocirc);

	/* The second layer */

	s_hidden2_1 = Convolution(s_W2, s_hidden1_3, 12, 12, 16, 5, 5, 16, 16, bitlen, (ArithmeticCircuit*) circ, posids_W2, W2posids_index);
	s_hidden2_2 = BatchnormAct(s_hidden2_1, s_u2, (ArithmeticCircuit*) circ);
	s_hidden2_3 = ActivationMax(s_hidden2_2, 8, 8, 16, bitlen, (ArithmeticCircuit*) circ, (BooleanCircuit*) booleancirc, (BooleanCircuit*) yaocirc);

	/* The Third layer*/

	s_hidden3_1 = Fullconnection(s_W3, s_hidden2_3, 100*256, 100, 256, bitlen, (ArithmeticCircuit*) circ, posids_W3, W3posids_index);
	s_hidden3_2 = BatchnormAct(s_hidden3_1, s_u3, (ArithmeticCircuit*) circ);
	s_hidden3_3 = Activation(s_hidden3_2, 100, bitlen, (ArithmeticCircuit*) circ, (BooleanCircuit*) booleancirc, (BooleanCircuit*) yaocirc);
	
	/* The forth layer*/
	s_hidden4_1 = Fullconnection(s_W4, s_hidden3_3, 10*100, 10, 100, bitlen, (ArithmeticCircuit*) circ, posids_W4, W4posids_index);
	s_hidden4_2 = Batchnorm(s_hidden4_1, s_s4, s_t4, (ArithmeticCircuit*) circ);
	
	/* make the pre-shared inputs to use in another circuit */	
	s_out = circ->PutSharedOUTGate(s_hidden4_2);
