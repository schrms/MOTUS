...
uint32_t* BNN_Mnist_Secure_prediction(e_role role, char* address, uint16_t port, seclvl seclvl,
	...
	*/
	...
	s_hidden1_1 = Convolution(s_W1, s_input, 28, 28, 1, 5, 5, 1, 16, bitlen, (ArithmeticCircuit*) circ);
	...
	s_hidden2_1 = Convolution(s_W2, s_hidden1_3, 12, 12, 16, 5, 5, 16, 16, bitlen, (ArithmeticCircuit*) circ);
	...
	s_hidden3_1 = Fullconnection(s_W3, s_hidden2_3, 100*4*4*16, 100, 4*4*16, bitlen, (ArithmeticCircuit*) circ);
	...
	/* The forth layer*/
	s_hidden4_1 = Fullconnection(s_W4, s_hidden3_3, 10*100, 10, 100, bitlen, (ArithmeticCircuit*) circ);
